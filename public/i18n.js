...
const STRINGS = {
  'header.subtitle': {
    fr: 'Images, données, audio, vidéo — 100% dans le navigateur, rien à installer',
    en: 'Images, data, audio, video — 100% in the browser, nothing to install',
  },
  ...
  'dropzone.multi': {
    fr: 'Glisse un ou plusieurs fichiers ici ou clique pour en choisir',
    en: 'Drag one or more files here, or click to choose',
  },
  'dropzone.multi.aria': { fr: 'Choisir un ou plusieurs fichiers à convertir', en: 'Choose one or more files to convert' },
  ...
  'btn.downloadZip': { fr: 'Tout (.zip)', en: 'All (.zip)' },
  'btn.downloadDiff': { fr: 'Télécharger la diff', en: 'Download the diff' },
  'results.label': { fr: 'Résultats', en: 'Results' },
  ...
  'error.zipCreation': { fr: "Échec de la création de l'archive ZIP.", en: 'Failed to create the ZIP archive.' },
  ...
  'error.generic': { fr: 'Échec.', en: 'Failed.' },

  'notify.compressionDone': { fr: 'Compression terminée', en: 'Compression done' },
  'notify.conversionDone': { fr: 'Conversion terminée', en: 'Conversion done' },
  'notify.batchCompressionDone': { fr: 'Compression terminée : {{success}}/{{total}} fichiers', en: 'Compression done: {{success}}/{{total}} files' },
  'notify.batchConversionDone': { fr: 'Conversion terminée : {{success}}/{{total}} fichiers', en: 'Conversion done: {{success}}/{{total}} files' },

  'batch.progressCompress': { fr: 'Compression {{i}}/{{n}} : {{name}}', en: 'Compressing {{i}}/{{n}}: {{name}}' },
  'batch.progressConvert': { fr: 'Conversion {{i}}/{{n}} : {{name}}', en: 'Converting {{i}}/{{n}}: {{name}}' },
  'batch.filesSelected': { fr: '{{n}} fichier{{plural}} sélectionné{{plural}}', en: '{{n}} file{{plural}} selected' },
  'batch.resultsCount': { fr: '{{success}}/{{total}} réussi{{plural}}', en: '{{success}}/{{total}} succeeded' },
